---
title: "Example Reference: AuthentiVoice"
description: "Parity-focused Mintlify migration reference using AuthentiVoice docs source."
---
...
- Build config: `/Volumes/S0/github/_sparkai/sparkify/refs/gen/authentivoice/sparkify.config.json`
- Output: `/Volumes/S0/github/_sparkai/sparkify/refs/gen/authentivoice/dist`
- Analysis: `/Volumes/S0/github/_sparkai/sparkify/refs/gen/authentivoice/PARITY_ANALYSIS.md`
