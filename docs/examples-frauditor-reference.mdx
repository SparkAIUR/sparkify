---
title: "Example Reference: Frauditor Backend"
description: "Live OpenAPI to endpoint-page docs generation reference for Frauditor backend."
---
...
- Build config: `/Volumes/S0/github/_sparkai/sparkify/refs/gen/frauditor-backend/sparkify.config.json`
- Output: `/Volumes/S0/github/_sparkai/sparkify/refs/gen/frauditor-backend/dist`
