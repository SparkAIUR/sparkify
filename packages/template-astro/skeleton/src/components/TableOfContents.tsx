...
export default function TableOfContents({
  ...
  useEffect(() => {
    ...
    const collected = Array.from(
      document.querySelectorAll<HTMLElement>('#main-content article :is(h2, h3)'),
    )
  ...
  const handleScroll = useCallback(() => {
    ...
    setActiveSlug(active || headingElements[0].id);
  }, [tocHeadings]);
  ...
  return (
    <>
      ...
      `}</style>
      <div className="toc-wrapper flex-col sticky top-[9.5rem] h-[calc(100vh-9.5rem)] w-80 shrink-0 pl-10">
