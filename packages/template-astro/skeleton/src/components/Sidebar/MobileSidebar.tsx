...
import { type SidebarItemStyle, type AnchorItem, type PageMetaMap } from './types';
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between px-4 pt-6 pb-4">
            {logoSrc ? (
              ...
              <div
                className="h-7 w-7 rounded-lg bg-primary/15 text-primary flex items-center justify-center"
                aria-label={siteName}
              >
                <Icon icon="shield" iconLibrary="lucide" size={16} />
              </div>
            )}
          </div>
